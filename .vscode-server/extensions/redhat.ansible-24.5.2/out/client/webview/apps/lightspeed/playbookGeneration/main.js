...
`}),$o={horizontal:"horizontal",vertical:"vertical"},wo={separator:"separator",presentation:"presentation"};class ko extends Ee{constructor(){super(...arguments),this.role=wo.separator,this.orientation=$o.horizontal}}M([P],ko.prototype,"role",void 0),M([P],ko.prototype,"orientation",void 0);class Io extends ko{}const To=Io.compose({baseName:"divider",template:(e,t)=>Ft`
...
`});class kn extends Ee{}class In extends(gs(kn)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const Tn={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class On extends In{constructor(){super(...arguments),this.type=Tn.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([P({attribute:"readonly",mode:"boolean"})],On.prototype,"readOnly",void 0),M([P({mode:"boolean"})],On.prototype,"autofocus",void 0),M([P],On.prototype,"placeholder",void 0),M([P],On.prototype,"type",void 0),M([P],On.prototype,"list",void 0),M([P({converter:D})],On.prototype,"maxlength",void 0),M([P({converter:D})],On.prototype,"minlength",void 0),M([P],On.prototype,"pattern",void 0),M([P({converter:D})],On.prototype,"size",void 0),M([P({mode:"boolean"})],On.prototype,"spellcheck",void 0),M([v],On.prototype,"defaultSlottedNodes",void 0);class Sn{}Zi(Sn,Ki),Zi(On,Xi,Sn);class An extends Ee{}class Rn extends(gs(An)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}const En={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class Dn extends Rn{constructor(){super(...arguments),this.resize=En.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([P({mode:"boolean"})],Dn.prototype,"readOnly",void 0),M([P],Dn.prototype,"resize",void 0),M([P({mode:"boolean"})],Dn.prototype,"autofocus",void 0),M([P({attribute:"form"})],Dn.prototype,"formId",void 0),M([P],Dn.prototype,"list",void 0),M([P({converter:D})],Dn.prototype,"maxlength",void 0),M([P({converter:D})],Dn.prototype,"minlength",void 0),M([P],Dn.prototype,"name",void 0),M([P],Dn.prototype,"placeholder",void 0),M([P({converter:D,mode:"fromView"})],Dn.prototype,"cols",void 0),M([P({converter:D,mode:"fromView"})],Dn.prototype,"rows",void 0),M([P({mode:"boolean"})],Dn.prototype,"spellcheck",void 0),M([v],Dn.prototype,"defaultSlottedNodes",void 0),Zi(Dn,Sn);class Bn extends Dn{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Pn=Bn.compose({baseName:"text-area",template:(e,t)=>Ft`
    <template
        class="
...
`,shadowOptions:{delegatesFocus:!0}}),Vn={vsCodeBadge:Gi,vsCodeButton:Ps,vsCodeCheckbox:Ms,vsCodeDataGrid:mo,vsCodeDataGridCell:Co,vsCodeDataGridRow:yo,vsCodeDivider:To,vsCodeDropdown:Go,vsCodeLink:Xo,vsCodeOption:Jo,vsCodePanels:nn,vsCodePanelTab:an,vsCodePanelView:dn,vsCodeProgressRing:un,vsCodeRadioGroup:gn,vsCodeRadio:Cn,vsCodeTag:wn,vsCodeTextArea:Pn,vsCodeTextField:Hn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(894);(0,t.provideVSCodeDesignSystem)().register((0,t.vsCodeButton)(),(0,t.vsCodeTag)(),(0,t.vsCodeTextArea)(),(0,t.vsCodeTextField)());let o,n,r;const a=acquireVsCodeApi();function l(e,t){const i=document.getElementById(e);i&&i.addEventListener("click",(async()=>{await t()}))}function d(e,t){const i=document.getElementsByClassName(e);for(let e=0;e<i.length;e++)i[e].style.display=t}async function c(){const e=document.getElementById("playbook-text-area");o=e.value,n=function(){const e=g();return e?.style.height}(),d("spinnerContainer","block"),a.postMessage({command:"summarizeInput",content:o}),e.focus()}function h(){const e=document.getElementById("playbook-text-area");e.value=r,e.focus()}function u(){d("bigIconButtonContainer","block"),d("examplesContainer","block"),d("resetFeedbackContainer","none"),d("firstMessage","block"),d("secondMessage","none"),d("generatePlaybookContainer","none");const e=document.getElementById("playbook-text-area");o&&(e.value=o),m(n),e.rows=5,e.focus()}async function p(){const e=document.getElementById("playbook-text-area").value;d("spinnerContainer","block"),a.postMessage({command:"generatePlaybook",content:e})}function f(){const e=document.getElementById("thumbsup-button"),t=document.getElementById("thumbsdown-button");e.setAttribute("class","iconButtonSelected"),t.setAttribute("class","iconButton"),a.postMessage({command:"thumbsUp"})}function b(){const e=document.getElementById("thumbsup-button"),t=document.getElementById("thumbsdown-button");e.setAttribute("class","iconButton"),t.setAttribute("class","iconButtonSelected"),a.postMessage({command:"thumbsDown"})}function g(){const e=document.querySelector("vscode-text-area")?.shadowRoot;return e?.querySelector("textarea")}function m(e=""){const t=g();t&&(t.style.height=e)}window.addEventListener("load",(()=>{l("submit-button",c),l("generate-button",p),l("reset-button",h),l("thumbsup-button",f),l("thumbsdown-button",b),l("back-button",u),function(){const e=document.getElementById("playbook-text-area"),t=document.getElementById("submit-button");e&&e.addEventListener("input",(async()=>{const i=e.value;t.disabled=0===i.length,function(){const e=g();if(e?.scrollHeight){const t=e?.scrollHeight;if(t<500){if(e?.style.height&&parseInt(e?.style.height)>=t)return;e.style.height=`${t+2}px`}}}()}))}(),o="",r=""})),window.addEventListener("message",(e=>{const t=e.data;switch(t.command){case"focus":document.getElementById("playbook-text-area").focus();break;case"summary":{document.getElementById("submit-icon").setAttribute("class","codicon codicon-run-all"),d("spinnerContainer","none"),d("bigIconButtonContainer","none"),d("examplesContainer","none"),d("resetFeedbackContainer","block"),d("firstMessage","none"),d("secondMessage","block"),d("generatePlaybookContainer","block");const e=document.getElementById("playbook-text-area");r=e.value=t.summary,m(),e.rows=25;break}case"exception":d("spinnerContainer","none")}}))})();var o=s.B;export{o as __esModule};
