...
`}),$o={horizontal:"horizontal",vertical:"vertical"},wo={separator:"separator",presentation:"presentation"};class ko extends Re{constructor(){super(...arguments),this.role=wo.separator,this.orientation=$o.horizontal}}M([P],ko.prototype,"role",void 0),M([P],ko.prototype,"orientation",void 0);class Io extends ko{}const To=Io.compose({baseName:"divider",template:(e,t)=>Ft`
