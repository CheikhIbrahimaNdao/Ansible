...
`,shadowOptions:{delegatesFocus:!0}}),Vn={vsCodeBadge:Gi,vsCodeButton:Bs,vsCodeCheckbox:Ms,vsCodeDataGrid:vo,vsCodeDataGridCell:Co,vsCodeDataGridRow:yo,vsCodeDivider:Io,vsCodeDropdown:Go,vsCodeLink:Xo,vsCodeOption:Jo,vsCodePanels:nn,vsCodePanelTab:an,vsCodePanelView:dn,vsCodeProgressRing:un,vsCodeRadioGroup:gn,vsCodeRadio:Cn,vsCodeTag:wn,vsCodeTextArea:Bn,vsCodeTextField:Hn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(894);(0,t.provideVSCodeDesignSystem)().register(t.allComponents);const o=acquireVsCodeApi();let n,r,a,l,d,c,h,u,p;function f(){o.postMessage({message:"refresh-page"})}window.addEventListener("load",(function(){n=document.getElementById("system-check"),n&&(n.style.visibility="hidden"),r=document.getElementById("install-status"),a=document.createElement("section"),l=document.createElement("section"),d=document.createElement("section"),c=document.createElement("section"),u=document.createElement("section"),h=document.createElement("section"),p=document.getElementById("refresh"),p?.addEventListener("click",f),o.postMessage({message:"set-system-status-view"}),window.addEventListener("message",(e=>{const t=e.data;if("systemDetails"===t.command){const e=t.arguments,i=e["ansible version"],s=e["ansible location"],o=e["python version"],n=e["python location"],p=e["ansible-creator version"],f=e["ansible-dev-environment version"];a.innerHTML=i?`<p class='found'>ansible version: ${i}</p>`:"<p class='not-found'>ansible version: Not found</p>",r?.appendChild(a),l.innerHTML=s?`<p class='found'>ansible location: ${s}</p>`:"<p class='not-found'>ansible location: Not found</p>",r?.appendChild(l),d.innerHTML=o?`<p class='found'>python version: ${o}</p>`:"<p class='not-found'>python version: Not found</p>",r?.appendChild(d),c.innerHTML=n?`<p class='found'>python location: ${n}</p>`:"<p class='not-found'>python location: Not found</p>",r?.appendChild(c),h.innerHTML=p?`<p class='found'>ansible-creator version: ${p}</p>`:'\n          <p class=\'not-found\'>ansible-creator version: Not found</p>\n          <p>Before getting started, please <vscode-link href="command:ansible.content-creator.install">install ansible-creator</vscode-link> (via pip) or <br>\n          <vscode-link href="command:ansible.python-settings.open">switch to a different python interpreter</vscode-link>  with ansible-creator already installed in it.</p>\n          ',r?.appendChild(h),u.innerHTML=f?`<p class='found'>[optional] ansible-dev-environment version: ${f}</p>`:"<p class='not-found-optional'>[optional] ansible-dev-environment version: Not found</p>",r?.appendChild(u)}n&&(n.style.visibility="visible")}))}))})();var o=s.B;export{o as __esModule};
