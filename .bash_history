...
cd /home/ndao/mysql_setup/templates/
sudo ./shell_script.sh
DB1="db1" USER1="user1" DB2="db2" USER2="user2" ... DB10="db10" USER10="user10" ./create_databases.sh
sudo ./shell_script.sh
sudo service mysql restart
sudo ./shell_script.sh
DB1="db1" DB2="db2" DB3="db3" USER1="user1" USER2="user2" USER3="user3" ./shell_script.sh
sudo mysql -u root 
sudo mysql -u cheikh 
sudo mysql -u cheikh -p
sudo mysql -u root 
sudo mysql -u user1 -p 
sudo mysql -u root 
cd ~
ansible-playbook Github.yml --ask-become-pass
ansible-playbook Github.yml --ask-vault-pass
git push -f
ansible-playbook Github.yml --ask-vault-pass
git push -f
...
clear
DB1="db1" DB2="db2" DB3="db3" USER1="user1" USER2="user2" USER3="user3" ./shell_script.sh
sudo DB1="db1" DB2="db2" DB3="db3" USER1="user1" USER2="user2" USER3="user3" ./shell_script.sh
cd ~
ansible-playbook Github.yml --ask-vault-pass
cd /home/ndao/mysql_setup/templates/
sudo DB1="CIN"  USER1="Cheikh" ./shell_script.sh
sudo mysql -u root 
sudo DB1="CIN"  USER1="Cheikh" ./shell_script.sh
sudo mysql -u root 
sudo DB1="CIN"  USER1="Cheikh" ./shell_script.sh
